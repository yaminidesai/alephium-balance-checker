...
describe('sendAlph', () => {
  ...
  describe('invalid destination address', () => {
    it('should throw an error when buildTransferTx fails due to invalid address', async () => {
      const errorMessage = 'Invalid destination address'
    ...
    it('should throw an error when transaction submission fails', async () => {
      const errorMessage = 'Address not found on network'
